...
var core = {
	addon: {
		...
		path: {
			...
			locale: 'chrome://comm/locale/',
			//
			modules: 'chrome://comm/content/modules/',
			workers: 'chrome://comm/content/modules/workers/',
			//
			resources: 'chrome://comm/content/resources/',
			images: 'chrome://comm/content/resources/images/',
			scripts: 'chrome://comm/content/resources/scripts/',
			styles: 'chrome://comm/content/resources/styles/',
			fonts: 'chrome://comm/content/resources/styles/fonts/',
			pages: 'chrome://comm/content/resources/pages/'
